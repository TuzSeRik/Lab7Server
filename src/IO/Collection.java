...
public class Collection {
    ...
    public Collection.Commands commands;
    ...
    public class Commands {
        ...
        void initialise(String key){
            try {
                ...
                Scanner reader = new Scanner(new File(System.getenv("INPUTPATH")));
        ...
        public void addIfMax(String jsonObject){
            try {
        ...
        public void save(){
            try{
                BufferedOutputStream bfos=new BufferedOutputStream(new FileOutputStream(System.getenv("INPUTPATH"), true));
                for (Shorty x : collection) {
